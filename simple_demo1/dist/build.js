...
var update = __webpack_require__(11)("ef02fd14", content, false, {});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm.isShow
      ? _c("div", {
          staticStyle: { height: "100px", "background-color": "red" }
        })
      : _vm._e(),
    _vm._v(" "),
    _c("hr"),
    ...
    _c("div", {
      ...
      staticStyle: { height: "100px", "background-color": "green" }
    }),
    _vm._v(" "),
    _c("hr"),
    _vm._v("\n      v-model:\n      "),
    _c("input", {
      ...
      attrs: { type: "text", name: "" },
      domProps: { value: _vm.mTest },
      on: {
        input: function($event) {
          if ($event.target.composing) {
            return
          }
          _vm.mTest = $event.target.value
        }
      }
    }),
    _vm._v("\n      " + _vm._s(_vm.mTest) + "\n      "),
    _c("br"),
    _vm._v('给下面的input的value赋值用v-bind:value="mTest"\n      '),
    _c("input", {
      attrs: { type: "text", name: "" },
      domProps: { value: _vm.mTest }
    })
